    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          pakageManager = process.env.npm_config_user_agent;
          manager = "npm";
          if (pakageManager && pakageManager.includes("pnpm")) manager = "pnpm";
          console.log(chalk.green("To start your project, run:"));
          console.log(chalk.green("==============="));
          console.log(chalk.green("cd ".concat(folderName)));
          console.log(chalk.green("".concat(manager, " install")));
          console.log(chalk.green("".concat(manager, " run dev")));
        case 10:
        case "end":
